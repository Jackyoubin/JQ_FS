...
class DataApi(object):
    ...
    def __init__(self, price='close', fq='post',
        ...
        if price in valid_price:
            ...
            raise ValueError("invalid 'price' parameter, "
    ...
    def get_prices(self, securities, start_date=None, end_date=None,
        ...
        #相当于_get_trade_days(start_date=end_date,end_date=None),return:从end_date到今天的交易日列表
    ...
    def _get_industry(self, securities, start_date, end_date,
                      industry='jq_l1'):
        trade_days = self._get_trade_days(start_date, end_date)
        industries = map(partial(self.api.get_industry, securities), trade_days)  #迭代器
        ...
        industries = {
            ...
            for d, ind in zip(trade_days, industries)   #d:日期，ind:字典
        }
    ...
    def _get_market_cap(self, securities, start_date, end_date, ln=False):
        ...
        #if not。None,False,0,空列表[],空字典{},空元祖(),都相当于false
            if not s:
